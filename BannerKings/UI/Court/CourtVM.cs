    ...
    internal class CourtVM : BannerKingsViewModel
    {
        ...
        public override void RefreshValues()
        {
            ...
            if (council.IsRoyal && diplomacy != null)
            {
                ...
                CourtInfo.Add(new InformationElement(new TextObject("{=ZLY2NQoN}Legitimacy:").ToString(),
                    ...
                    .ToString(),
                    new TextObject("{=ZLY2NQoN}Legitimacy represents how a ruler is seen by the other members of a realm, concerning their right to rule.{newline}{newline}Legitimacy Target: {TARGET}{newline}{newline}{EXPLANATIONS}")
